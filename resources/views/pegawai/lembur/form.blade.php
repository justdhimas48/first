...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div class="input-group date" id="datetimepicker1" data-target-input="nearest" onkeydown="return false">
            <input type="text" class="form-control datetimepicker-input" name="waktu_mulai_lembur"
                data-target="#datetimepicker1" value="<?php echo isset($lemburPegawai->jadwal_mulai_lembur) ? date('H:i', strtotime($lemburPegawai->jadwal_mulai_lembur)) : ''; ?>" />
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div class="input-group date" id="datetimepicker2" data-target-input="nearest" onkeydown="return false">
            <input type="text" class="form-control datetimepicker-input" name="waktu_selesai_lembur"
                data-target="#datetimepicker2" value="<?php echo isset($lemburPegawai->jadwal_selesai_lembur) ? date('H:i', strtotime($lemburPegawai->jadwal_selesai_lembur)) : ''; ?>" />
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        @if (isset($lemburPegawai->lampiran))
            <a href="{{ asset($lemburPegawai->lampiran) }}"><?php echo explode('/', $lemburPegawai->lampiran)[3]; ?></a>
        @endif
