...
@if (isset($pelamar))
    ...
    @foreach ($pelamar as $v)
        <a class="dropdown-item" href="#" id="{{$v->id}}">
            //?php echo $v->id . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' .$v->nama ?>
        </a>
    @endforeach
    </div>
@else
...
<div class="form-group mx-2">
    <label>Pelamar</label>
    @if (isset($pelamar))
        <select class='form-control' name='pelamar' id='pelamar' required>
            <option class="" value="">Pilih Pelamar</option>
            @foreach ($pelamar as $v)
                <option value="{{ $v->id }}">
                    {{ $v->id . ' - ' . $v->nama }}
                </option>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        @if (isset($pelamar))
            <div class="dropdown">
                <button class="btn btn-light dropdown-toggle" type="button" id="btn-jenis-interview"
