...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
        <div class="card-header"> Mutasi Unit Kerja
        </div>
        
        <div class="card-body">
        <form class="form-horizontal" action="{{ route('admin.mutasi-unitkerja.store') }}" method="post" enctype="multipart/form-data"> 
            {{ csrf_field() }}
            <div class="form-group">
                ...
                @if (isset($unitkerja))
                    ...
                    <a class="dropdown-item" href="#" id="{{$v->id}}"><?php echo $v->id . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' .$v->nama. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'. $v->nama_kategori_unit_kerja ?></a>
                    @endforeach
                    </div>
                @endif
                </div>
            ...
            {{-- <div class="form-group mx-2">
                ...
                <div>
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Mutasi Pekerjaan Unit Kerja ke Pegawai</label>
                    </div>
        
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="cb-jabatan" name="cb_jabatan">
                            <label class="form-check-label" for="exampleCheck1">Mutasi Jabatan Unit Kerja</label>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <div class="dropdown">
                    <button class="btn btn-light dropdown-toggle" type="button" id="btn-kategori-unit-kerja" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Kategori Unit Kerja
                    </button>
            ...
            <div class="form-group">
                ...
                <a href="{{ route('admin.mutasi-unitkerja.index') }}" class="btn btn-primary" role="button">Batal</a>
                </div>
            </div>
        </form>
        </div>
