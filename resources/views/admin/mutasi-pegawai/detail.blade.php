...
<div class="container">
    <div class="row">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <p class="text-muted col-xl-3 my-auto"><b>Unit Kerja Sebelum</b></p>
                <p class="col-xl-9 my-auto">{{$mutasiPegawai->kategori_unit_kerja_sebelum}}</p>                  
            </div>
            <hr class="my-2" />
            
            <div class="row">
                <p class="text-muted col-xl-3 my-auto"><b>Unit Kerja Tujuan</b></p>
                <p class="col-xl-9 my-auto">{{$mutasiPegawai->kategori_unit_kerja_sesudah}}</p>                  
            </div>
            <hr class="my-2" />
            ...
            <div class="row">
                ...
                <a href="{{ asset($mutasiPegawai->lampiran) }}"><?php echo explode('/', $mutasiPegawai->lampiran)[3]; ?></a>                
            </div>
            <hr class="my-2" />
