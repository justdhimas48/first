            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="table-layout: fixed">
                <thead>
                    <tr>
                        ...
                        <th style="width: 30%">Unit Kerja Sebelum</th>
                        <th style="width: 30%">Unit Kerja Tujuan</th>
                ...
                @forelse($mutasiPegawai as $item)
                    <tr>
                        ...
                        <td>{{ $item->kategori_unit_kerja_sebelum }}</td>
                        <td>{{ $item->kategori_unit_kerja_sesudah }}</td>
