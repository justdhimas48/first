        ...
        <div class="card">
            <div class="card-header">
                <div class="row justify-content-between">
                    ...
                    @if ($trainingPegawai->status == 1)
                        <a href="{{(isset($trainingPegawai->surat_izin_pelatihan) ? asset($trainingPegawai->surat_izin_pelatihan) : route('admin.training-pegawai.cetak-sip', $trainingPegawai->id))}}" class="btn btn-success ml-4">Cetak SK</a>
                    @endif
                </div>
            </a>
        </div>
