...
<div class="register-box">
  <div class="register-logo">
    <a href="{{url('/admin')}}"><b>Aplikasi Human Resorce Universitas Bina Darma</a>
  </div>
  ...
  <div class="card">
    ...
    <div class="input-group mb-3">
      <input type="role" name="role" class="form-control @error('role') is-invalid @enderror" placeholder="Role">
      <div class="input-group-append">
        <div class="input-group-text">
          <span class="fas fa-lock"></span>
        </div>
