...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div class="dropdown">
            <button class="btn btn-primary dropdown-toggle" type="button" id="btn-jenis-kelamin" data-toggle="dropdown"
    ...
    @if (isset($jenis_kelamin)) {{ $jenis_kelamin == 0 ? 'Laki-Laki' : 'Perempuan' }}
    @else
        Jenis Kelamin @endif
    " />
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="pendidikan_s1" class="form-control" value="{{ $pendidikan_s1 ?? '' }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="pendidikan_s2" class="form-control" value="{{ $pendidikan_s2 ?? '' }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="pendidikan_s3" class="form-control" value="{{ $pendidikan_s3 ?? '' }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        @if (isset($pekerjaan_tujuan))
            <select class="form-control" name="pekerjaan_tujuan">
                <option value="karyawan" {{ ($pekerjaan_tujuan == "karyawan") ? 'selected' : '' }}>Karyawan</option>
                <option value="dosen" {{ ($pekerjaan_tujuan == "dosen") ? 'selected' : '' }}>Dosen</option>
            </select>
        @else
            <select class="form-control" name="pekerjaan_tujuan">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="jurusan_bidang" class="form-control" value="{{ $jurusan_bidang ?? '' }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="nidn" class="form-control" value="{{ $nidn ?? '' }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        @if (isset($kompetensi_khusus))
            <div class="mb-4">
                <img height="300px" src="{{ asset($kompetensi_khusus) }}" alt="">
            </div>
        @endif
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="string" name="keterangan_kompetensi_khusus" class="form-control"
            value="{{ $deskripsi_kompetensi_khusus ?? '' }}">
    </div>
</div>
