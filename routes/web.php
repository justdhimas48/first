...
Route::middleware('role:admin')->group(function () {
    ...
    Route::get('/datapelamar/print_pelamar', [App\Http\Controllers\DatapelamarController::class, 'printPelamar'])->name('datapelamar.print');;
    ...
    Route::get('/datapelamar/print_data_pelamar', [App\Http\Controllers\DatapelamarController::class, 'printDataPelamar'])->name('datapelamar.print-data-pelamar');
    ...
    Route::get('/admin_dashboard/data_pegawai/print', [App\Http\Controllers\Admin\DataPegawaiController::class, 'print'])->name('admin.data-pegawai.print');
    Route::get('/admin_dashboard/data_karyawan', [App\Http\Controllers\Admin\DataPegawaiController::class, 'indexKaryawan'])->name('admin.data-karyawan.index');
    Route::get('/admin_dashboard/data_karyawan/print', [App\Http\Controllers\Admin\DataPegawaiController::class, 'printKaryawan'])->name('admin.data-karyawan.print');
    ...
    Route::get('/admin_dashboard/data_karyawan/print-data-karyawan', [App\Http\Controllers\Admin\DataPegawaiController::class, 'printDataKaryawan'])->name('admin.data-karyawan.print-data-karyawan');
    ...
    Route::get('/admin_dashboard/kategori_unit_kerja', [App\Http\Controllers\Admin\KategoriUnitKerjaController::class, 'index'])->name('admin.kategori-unit-kerja.index');
    Route::post('/admin_dashboard/kategori_unit_kerja/store', [App\Http\Controllers\Admin\KategoriUnitKerjaController::class, 'store'])->name('admin.kategori-unit-kerja.store');
    Route::get('/admin_dashboard/kategori_unit_kerja/active/{id}', [App\Http\Controllers\Admin\KategoriUnitKerjaController::class, 'active'])->name('admin.kategori-unit-kerja.active');
    Route::get('/admin_dashboard/kategori_unit_kerja/edit/{id}', [App\Http\Controllers\Admin\KategoriUnitKerjaController::class, 'edit'])->name('admin.kategori-unit-kerja.edit');
    Route::post('/admin_dashboard/kategori_unit_kerja/update', [App\Http\Controllers\Admin\KategoriUnitKerjaController::class, 'update'])->name('admin.kategori-unit-kerja.update');
});
...
Route::middleware('role:pelamar')->group(function () {
    ...
    Route::post('/pelamar_dashboard/informasi_diri/store', [App\Http\Controllers\Pelamar\DashboardController::class, 'store'])->name('pelamar.informasi-diri.store');
