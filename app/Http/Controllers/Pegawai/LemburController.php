...
class LemburController extends Controller
{
    ...
    { 
        ...
        if($request->lampiran){
            ...
            $inputs['lampiran'] = 'storage/lembur_pegawai/'.$request->pegawai.'/'.$namefile;
            request('lampiran')->storeAs('lembur_pegawai/'.$request->pegawai, $namefile, 'public');
            $lemburPegawai->lampiran = $inputs['lampiran'];
        }
