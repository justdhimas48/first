...
class DataUnitKerjaController extends Controller
{
    ...
    public function edit($id) {
        $unitkerja = DB::table('tbl_dataunitkerja')
                    ...
                    ->join('tbl_kategori_unit_kerja', 'tbl_kategori_unit_kerja.id', '=', 'tbl_dataunitkerja.id_kategori_unit_kerja')
                    ->select(DB::raw('tbl_dataunitkerja.*, tbl_kontrak_unitkerja.lama_kontrak as lama_kontrak, tbl_kategori_unit_kerja.nama as kategori_unit_kerja'))
