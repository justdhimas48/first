...
class PenugasanPegawaiController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->lampiran){
            ...
            $inputs['lampiran'] = 'storage/penugasan_pegawai/'.$request->pegawai.'/'.$namefile;
            request('lampiran')->storeAs('penugasan_pegawai/'.$request->pegawai, $namefile, 'public');
            $penugasanPegawai->lampiran = $inputs['lampiran'];
        }
